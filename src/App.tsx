        ...
        <div className="container">
          <div className="contact">
            ...
            <div className="contact-links">
              <a href="mailto:michael@example.com" className="contact-link">Email</a>
              <a href="https://github.com/thealmikey" target="_blank" rel="noopener noreferrer" className="contact-link">GitHub</a>
